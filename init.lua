...
vim.api.nvim_create_autocmd("FileType", {
	...
	callback = function()
		vim.cmd([[
		" Enhanced general programming syntax highlighting

		" Special comments with keywords
		syntax keyword TodoComment TODO FIXME NOTE BUG HACK WARNING XXX contained
		highlight TodoComment guifg=#ff9500 gui=bold
